namespace CustomUnityLibrary
{
    ...
    /// </summary>
    public class SoundManager : ManagerBehaviour<SoundManager>
    {
        void Reset()
        {
        ...
        public void Play(AudioClip clip, bool loop = false, GameObject sourceGameObject = null)
        {
            if (!sourceGameObject)
            {
        ...
        public void Stop(GameObject sourceGameObject = null)
        {
            if (!sourceGameObject)
            {
                sourceGameObject = gameObject;
        ...
        public void Stop(AudioClip clip, GameObject sourceGameObject = null)
        {
            if (!sourceGameObject)
            {
                sourceGameObject = gameObject;
